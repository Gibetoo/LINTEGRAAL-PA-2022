...
<body>
    ...
    <main class="container">
        ...
        <?php foreach ($results as $profil) { ?>
            <form class="mb-5 text-white" action="verification/verif_modif_profil.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3 w-25">
                ...
                <input type="hidden" name="article_email" value="<?= $profil['email']; ?>">
                <div class="mb-5">
