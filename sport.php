...
<body>
    ...
    <?php include('verification/verif_afficher_article_sport.php');?>
    <main class="container">
        <h1 class="my-5 pb-3 h1 text-white d-flex justify-content-center border-bottom">Actualités Sportives</h1>
        <?php include('includes/message.php') ?>
