...
<body>
    ...
    <?php include('verification/verif_afficher_article_international.php');
    ?>

    <main class="container">
        <h1 class="my-5 pb-3 h1 text-white d-flex justify-content-center border-bottom">Actualités Internationals</h1>
        <?php include('includes/message.php') ?>
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <?php
            while ($post = $AllPostinter->fetch()) {
            ?>
                <div class="col">
                    <div class="card">
